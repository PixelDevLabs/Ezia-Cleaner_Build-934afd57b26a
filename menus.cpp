...
static int16_t ResolutionInit(
	Menu* pmenuCur,
	int16_t sInit);

static bool ResolutionChoice(
	Menu* pemnuCur,
	int16_t sMenuItem);
...
extern Menu	menuVideoOptions =
	...
	// Menu items.
		{	// pszText,					sEnabled,	pmenu,					pgui
			...
			//{ g_pszVideoMenu_Resolution, TRUE,		&menuResolutionOptions,		NULL, },
			{ "",					FALSE,			NULL,					NULL,},
			NULL							// Terminates list.
		},
	};

// Resolution Menu -Ezia
extern Menu menuResolutionOptions =
{
	CONTROLS_MENU_ID,
	...
	// Menu callbacks.
	{	// fnInit, fnChoice,
		ResolutionInit,		// Called before menu is initialized.
		ResolutionChoice,	// Called when item is chosen.
	},
	...
	// Menu items.
	{	// pszText,												sEnabled,	pmenu,					pgui
		{ "320x240", TRUE, NULL, NULL, },
		{ "640x480", TRUE, NULL, NULL, },
		{ "800x600", TRUE, NULL, NULL, },
		{ "1024x768", TRUE, NULL, NULL, },
		{ "1280x720", TRUE, NULL, NULL, },
		{ "1600x900", TRUE, NULL, NULL, },
		{ "1920x1080", TRUE, NULL, NULL, },
		{ "2560x1440", TRUE, NULL, NULL, },
		{ "3840x2160", TRUE, NULL, NULL, },
		{ "7680x4320", TRUE, NULL, NULL, },
		{ "", FALSE, NULL, NULL, },
		NULL							// Terminates list.
	},
...
////////////////////////////////////////////////////////////////////////////////
//
// Called to init or kill the resolution options menu.
//
////////////////////////////////////////////////////////////////////////////////
static int16_t ResolutionInit(	// Returns 0 on success, non-zero to cancel menu.
	Menu*	pmenuCur,					// Current menu.
	int16_t	sInit)						// TRUE, if initializing; FALSE, if killing.
{
	int16_t	sRes = 0;	// Assume success.
...
////////////////////////////////////////////////////////////////////////////////
//
// Called when a choice is made or changed on the resolution options menu.
//
// Doesn't work fully yet. Just experimental.
////////////////////////////////////////////////////////////////////////////////
static bool ResolutionChoice(	// Returns true to accept, false to deny choice.
	Menu*	pmenuCurrent,				// Current menu.
	int16_t	sMenuItem)					// Item chosen or -1 for change of focus.
{
	bool	bAcceptChoice = true;	// Assume accepting.
	int16_t RequestedWidth;
	...
	rspGetVideoMode(&sDeviceDepth, &sDeviceWidth, &sDeviceHeight, NULL, NULL, NULL, &sPages, &sScaling);
