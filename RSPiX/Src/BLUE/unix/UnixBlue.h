...
// Temp fix until merged with Gravis' input changes

#define RSP_MB_NONE				0	// No mouse event
#define RSP_MB0_RELEASED		SDL_MOUSEBUTTONUP	// Mouse button 0 was released
#define RSP_MB0_PRESSED			SDL_MOUSEBUTTONDOWN	// Mouse button 0 was pressed
...
extern int PrefsViewWidth;
extern int PrefsViewHeight;
